...
<div class="space-y-4">
    ...
    <div class="bg-white rounded-2xl shadow overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tr><td colspan="6" class="text-center py-10 text-gray-400">Tiada profil dijumpai.</td></tr>
            ...
            <tr id="row-<?= $p['id'] ?>">
                ...
                <td class="px-4 py-3 text-gray-500 hide-mobile"><?= htmlspecialchars($p['department'] ?? '-') ?></td>
                ...
                <td class="px-4 py-3 text-center">
                    <div class="flex items-center justify-center gap-1">
                        ...
                        <form method="POST" action="/api/delete_profile.php" class="inline" onsubmit="return confirmAction('Padam profil ini?')">
                            <input type="hidden" name="id" value="<?= $p['id'] ?>">
                            <button type="submit" class="p-1.5 text-gray-400 hover:text-red-500" title="Padam">
    ...
    <p class="text-xs text-gray-400">Jumlah: <?= count($profiles) ?> profil</p>
</div>
